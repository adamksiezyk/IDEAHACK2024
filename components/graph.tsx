...
function transformGraph(graph: any) {
  ...
  nodes: [
    {
      ...
      patents: ["Method for Enhancing Neural Network Efficiency"],
      projectHistory: ["proj1", "proj3"],
      education: [
        {
          degree: "PhD",
      ...
      desiredRoles: ["Technical Advisor", "Research Lead"],
      preferredIndustries: ["Healthcare", "Robotics"],
    ...
    },
    {
      ...
      expertise: ["Materials Science", "Nanotechnology", "Green Chemistry"],
      skills: ["Lab Management", "Grant Writing", "Materials Characterization"],
      publications: [
    ...
    },
    {
      ...
      department: "Physics",
      expertise: ["Quantum Mechanics", "Optics", "Photonics"],
      ...
      patents: ["CRISPR-Cas9 Gene Editing Mechanism"],
      projectHistory: ["proj4"],
      education: [
        {
          degree: "PhD",
          field: "Physics",
    ...
    },
    {
      ...
      expertise: ["Data Science", "Big Data Analytics", "Machine Learning"],
      skills: ["Python", "SQL", "TensorFlow", "Cloud Computing"],
      publications: [
        "AI-Driven Diagnosis for Rare Diseases",
        "Photonics for Quantum Computing Applications",
      ],
      patents: ["Optimized Vaccine Delivery via mRNA Technology"],
      projectHistory: ["proj5"],
      education: [
        {
          degree: "PhD",
          field: "Data Science",
    ...
    },
    {
      ...
      expertise: ["Gene Editing", "CRISPR", "Synthetic Biology"],
      skills: ["Lab Management", "DNA Sequencing", "Data Analysis"],
      publications: [
        "Carbon Capture Using Engineered Microalgae",
        "CRISPR Applications in Cancer Immunotherapy",
      ],
      patents: ["Advanced Digital Twin Modelling for Predictive Maintenance"],
      projectHistory: ["proj6"],
      education: [
        {
          degree: "PhD",
          field: "Biotechnology",
    ...
    },
    {
      ...
      patents: ["Sustainable Chemical Processes for Biofertilizer Production"],
      projectHistory: ["proj10", "proj11"],
      education: [
        {
          degree: "PhD",
          field: "Computer Science",
    ...
    },
    {
      ...
      patents: ["Neural Interfaces for Robotic Arm Control"],
      projectHistory: ["proj1", "proj11"],
      education: [
        {
          degree: "PhD",
          field: "Computer Science",
    ...
    },
    {
      ...
      institution: "National Institutes of Health",
      department: "Biotechnology",
      expertise: ["Synthetic Biology", "CRISPR", "Gene Editing"],
      skills: ["DNA Sequencing", "Lab Management", "Data Analysis"],
      publications: [
        "Advanced Quantum Cryptography Protocols",
        "Bioplastics Derived from Algae: A Sustainable Approach",
      ],
      patents: ["High-Efficiency Renewable Energy Smart Grids"],
      projectHistory: ["proj6", "proj12"],
      education: [
        {
          degree: "PhD",
          field: "Biotechnology",
    ...
    },
    {
      ...
      expertise: ["Materials Science", "Nanotechnology", "Green Chemistry"],
      skills: ["Materials Characterization", "Lab Management", "Grant Writing"],
      publications: [
        "Next-Generation mRNA Vaccine Development",
        "Neural Interfaces for Robotics: A Study",
      ],
      patents: ["Engineered Microalgae for Carbon Capture"],
      projectHistory: ["proj2", "proj13"],
      education: [
        {
          degree: "PhD",
    ...
    },
    {
      ...
      institution: "MIT",
      department: "Physics",
      expertise: ["Quantum Computing", "Quantum Error Correction", "Photonics"],
      skills: ["Python", "MATLAB", "Circuit Simulation"],
      publications: [
        "Digital Twin Technology for Smart Factories",
        "Green Chemistry in Sustainable Agriculture",
      ],
      patents: ["Photonics-Based Quantum Computing Circuit Design"],
      projectHistory: ["proj4", "proj14"],
      education: [
        {
          degree: "PhD",
          field: "Physics",
    ...
    },
    {
      ...
      institution: "Stanford University",
      department: "Computer Science",
      expertise: ["Humanoid Robotics", "Machine Learning", "Control Systems"],
      skills: ["Python", "TensorFlow", "Control Theory", "ROS"],
      publications: [
        "AI-Driven Diagnosis for Rare Diseases",
        "Photonics for Quantum Computing Applications",
      ],
      patents: ["Robotics Motion Control Using AI Optimization"],
      projectHistory: ["proj5", "proj8"],
      education: [
        {
          degree: "PhD",
          field: "Robotics",
    ...
    },
    {
      ...
      abstract:
        "This project aims to develop an artificial intelligence-powered diagnostic tool to identify rare diseases based on patient symptoms, genetic data, and medical imaging.",
      id: "pp1",
    },
    {
      type: "project-proposal",
      ...
      abstract:
        "The project focuses on creating sustainable, eco-friendly chemical processes to produce biofertilizers and pest-control agents.",
      id: "pp2",
    },
    {
      type: "project-proposal",
      ...
      abstract:
        "This project aims to integrate quantum cryptography techniques into Internet-of-Things (IoT) devices to secure communications against quantum computing attacks.",
      id: "pp3",
    },
    {
      type: "project-proposal",
      ...
      abstract:
        "The objective of this research is to explore the use of CRISPR-Cas9 technology to engineer immune cells capable of targeting and destroying cancer cells.",
      id: "pp4",
    },
    {
      type: "project-proposal",
      ...
      abstract:
        "This proposal seeks to develop digital twin technology to model and predict the behavior of industrial machinery in smart factories.",
      id: "pp5",
    },
    {
      type: "project-proposal",
      ...
      abstract:
        "This initiative proposes developing biodegradable plastics derived from algal biomass as a sustainable alternative to traditional petroleum-based plastics.",
      id: "pp6",
    },
    {
      type: "project-proposal",
      ...
      abstract:
        "The project focuses on developing advanced neural interfaces to control assistive robotic devices for individuals with disabilities.",
      id: "pp7",
    },
    {
      type: "project-proposal",
      ...
      abstract:
        "This project proposes the development of intelligent grid systems to optimize the integration and distribution of renewable energy sources like solar and wind.",
      id: "pp8",
    },
    {
      type: "project-proposal",
      ...
      abstract:
        "This proposal aims to design a scalable platform for rapid mRNA vaccine development to combat emerging infectious diseases.",
      id: "pp9",
    },
    {
      type: "project-proposal",
      ...
      abstract:
        "The project explores the potential of genetically engineered microalgae to capture atmospheric carbon dioxide and convert it into bioenergy.",
      id: "pp10",
    },
    {
